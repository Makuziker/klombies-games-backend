...
import { ICard, IInvalidGroupMessage } from '../models/five-crowns/types';
import { IUser } from '../types';

// Shared types

export type ISocketFn = (socket: Socket, server: Server) => void;
export type ICallback<R extends {} = {}> = (payload: { error?: string | IInvalidGroupMessage[]; request?: R; }) => void;
